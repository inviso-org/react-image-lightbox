...
var MAX_ZOOM_LEVEL = 100; // Size ratio between previous and next zoom levels
...
var ReactImageLightbox = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ReactImageLightbox, null, [{
    ...
    value: function getTransform() {
      ...
      var maxScaleFactor = MAX_ZOOM_LEVEL / 100;
      ...
      var nextX = x; // Make sure scaleFactor is not greater than maxScaleFactor
      // by choosing the lowest value.

      var scaleFactor = Math.min(maxScaleFactor, zoom * (targetWidth / width));
  ...
  _createClass(ReactImageLightbox, [{
    ...
    value: function render() {
      ...
      }, this.props.loading && loadingIcon, !this.props.loading && images), prevSrc && /*#__PURE__*/React__default.createElement("button", {
...
ReactImageLightbox.defaultProps = {
  ...
  handleKeyInput: function handleKeyInput() {}
};
