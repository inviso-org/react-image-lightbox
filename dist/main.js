!function(root, factory) {
        ...
        /* WEBPACK VAR INJECTION */ (function(global) {
            ...
            var ReactImageLightbox = function(_Component) {
                ...
                return function(subClass, superClass) {
                    ...
                    key: "getTransform",
                    value: function() {
                        var options = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, maxScaleFactor = _constant.MAX_ZOOM_LEVEL / 100, _options$x = options.x, x = void 0 === _options$x ? 0 : _options$x, _options$y = options.y, y = void 0 === _options$y ? 0 : _options$y, _options$zoom = options.zoom, zoom = void 0 === _options$zoom ? 1 : _options$zoom, width = options.width, targetWidth = options.targetWidth, zoomLevel = options.zoomLevel, nextX = x, scaleFactor = Math.min(maxScaleFactor, zoom * (targetWidth / width)), windowWidth = (0, 
                        _util.getWindowWidth)();
                        return width > windowWidth && (nextX += (windowWidth - width) / 2), 
                        ...
                        // want to touch.
                        options.zoom && zoomLevel === _constant.MAX_ZOOM_LEVEL && (scaleFactor = maxScaleFactor), 
                        {
     ...
     */                }, {
                    ...
                    value: function(event) {
                        ...
                        if (this.props.handleKeyInput && this.props.handleKeyInput(event), event.stopPropagation(), 
                        !this.isAnimating()) 
     ...
     */                }, {
                    ...
                    value: function() {
                        ...
                        this.pointerList = this.pointerList.filter(function(_ref2) {
                            return _ref2.source === _this8.eventsSource;
                        });
                    }
                }, {
                    key: "handleMouseDown",
            ...
            ReactImageLightbox.propTypes = {
                ...
                handleKeyInput: _propTypes2.default.func
 ...
 */
    ...
    /***/ function(module, exports, __webpack_require__) {
        ...
        exports.MIN_ZOOM_LEVEL = 0, exports.MAX_ZOOM_LEVEL = 100, exports.ZOOM_RATIO = 1.007, 
